...
echo "u-boot-exynos4212-evt0-nonfused.bin fusing..."
dd iflag=dsync oflag=dsync if=../u-boot-exynos4212-evt0-nonfused.bin of=$1 seek=1 && \
	echo "u-boot-exynos4212-evt0-nonfused.bin image has been fused successfully."
